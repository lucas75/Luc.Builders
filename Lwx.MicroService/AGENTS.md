# Lwx.MicroService - Project Context Summary
...
- Embedded resources use LogicalName: `Lwx.MicroService.%(RelativeDir)%(Filename)%(Extension)`
...
- **Project Config**: `Lwx.MicroService.csproj` with embedded resource configuration
