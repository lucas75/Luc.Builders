    ...
    public void Execute()
    {
        ...
        var configureSource = $$"""
            ...
            namespace {{ns}}
            {
                ...
                {
                    public static void ConfigureSwagger(IServiceCollection services, IHostEnvironment environment)
                    {
                        ...
                        {
                            var shouldAdd = environment.IsDevelopment() ?
                            ...
                            if (shouldAdd)
                            {
                                ...
                                {
                                    options.SwaggerDoc("{{version ?? "v1"}}", new Microsoft.OpenApi.Models.OpenApiInfo
                                    {
                                        Title = "{{title ?? "API"}}",
