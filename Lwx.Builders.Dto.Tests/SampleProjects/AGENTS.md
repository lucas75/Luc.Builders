...
3. Tests use the compile-error tests to run and inspect these sample projects (see `CompileErrorTests.cs` which calls `SharedTestHelpers.BuildAndRunSampleProject`). You can run the tests by executing the normal test target:
