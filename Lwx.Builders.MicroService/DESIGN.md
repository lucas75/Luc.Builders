...
This document specifies the design, consumer requirements and static-analysis rules for the Lwx.Builders.MicroService source generator and its associated attributes.
